...
os.execute("git clone -b v2.1 http://luajit.org/git/luajit-2.0.git")

local src_dir = dir .. "luajit-2.0/src"
lfs.chdir(src_dir)
...
do 
	...
	"xcopy \"luajit.exe\" \""..old_dir.."\" /Y /C /R\n" ..
	"xcopy \"lua51.dll\" \""..old_dir.."\" /Y /C /R\n" .. 
	"xcopy \"jit\" \""..old_dir.."\\jit\" /Y /C /R\n" .. 
	"start \"\" \"".. launcher .."\"\n"
