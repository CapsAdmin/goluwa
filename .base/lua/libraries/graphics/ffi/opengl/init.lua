...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLchar*const*, GL_LUA_ENUMS)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GL_LUA_ENUMS, GLfixed*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLint, GLsizei, GLboolean, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLhandleARB, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(const void *, GLsizei, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLboolean, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLuint*, GL_LUA_ENUMS, const void *, GLsizei)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLfloat*, GLubyte*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLuint64EXT*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLubyte*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLfloat, GLfloat, GLint, GLint, GLfloat*)', func)
		if ok then
		gl.Map1f = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLboolean(*)(GLsizei, GLuint*, GLboolean*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLuint (*)(GL_LUA_ENUMS, GLsizei, GLchar*const*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLsizei, GLenum*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLint, GLsizei, GLuint64*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLubyte*, GLdouble, GLdouble, GLdouble, GLdouble)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLdouble, GLdouble, GLint, GLint, GLdouble*)', func)
		if ok then
		gl.Map1d = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLubyte*, GLfloat, GLfloat, GLfloat, GLfloat)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLshort*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLuint, GLsizei, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLuint*, GLfixed*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GL_LUA_ENUMS, const void *, GLuint, GL_LUA_ENUMS, GL_LUA_ENUMS, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLdouble*)', func)
		if ok then
		gl.Uniform2dv = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLchar*)', func)
		if ok then
		gl.ObjectLabel = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLint (*)(GLuint, GL_LUA_ENUMS, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLint, GLsizei, GLuint64EXT*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GL_LUA_ENUMS, GL_LUA_ENUMS, GLsizei, GLuint*, GLboolean)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint*, GLubyte*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLchar*, GL_LUA_ENUMS, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLenum*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLuint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLint (*)(GLuint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLint, GLsizei, GLboolean, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLbyte*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLsizei*, GL_LUA_ENUMS, const void *const*, GLsizei, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLenum*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLuint64*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GL_LUA_ENUMS, GLuint, GL_LUA_ENUMS, GLsizei, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLboolean(*)(GLint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLchar*const*, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLuint*, GL_LUA_ENUMS, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLuint (*)(GLuint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLubyte*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLubyte*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLvdpauSurfaceNV*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLubyte*, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLint*)', func)
		if ok then
		gl.Uniform4iv = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GL_LUA_ENUMS, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLint, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLubyte*, GLsizei, GL_LUA_ENUMS, const void *)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLuint, GLsizei, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLuint*, GLclampf*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GL_LUA_ENUMS, const void *, GLuint, GLint, GLuint, GL_LUA_ENUMS, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLuint*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, const GLchar**, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLushort*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLubyte*(*)(GL_LUA_ENUMS)', func)
		if ok then
		gl.GetString = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLenum*, GLint*, GLsizei*, GLsizei, GLint)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLint64EXT*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLsizei, GLfloat, GLfloat, GLfloat, GLfloat, GLubyte*)', func)
		if ok then
		gl.Bitmap = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLuint, GLsizei, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLint, GLchar*, GLint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLenum*, GLsizei*, GL_LUA_ENUMS, const void *const*, GLsizei, GLint)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLshort*)', func)
		if ok then
		gl.WeightsvARB = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLsizei, GLboolean*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLuint (*)(GL_LUA_ENUMS, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLhandleARB, GLuint, const GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLfloat, GLfloat, GLint, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLhalfNV*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLsizei*, GL_LUA_ENUMS, const void *const*, GLsizei)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLubyte*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLdouble, GLdouble, GLint, GLint, GLdouble, GLdouble, GLint, GLint, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GL_LUA_ENUMS, const void *, GLuint, GLint, GLuint, GL_LUA_ENUMS, GL_LUA_ENUMS, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLsizei, GLuint*, GLintptr*, GLsizei*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLuint (*)(GLuint, GL_LUA_ENUMS, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLint (*)(GLhandleARB, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GL_LUA_ENUMS, GLuint, GLsizei, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLenum*, GLint, GLint, GLsizei, GLsizei)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLvdpauSurfaceNV(*)(const void *, GL_LUA_ENUMS, GLsizei, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLsizei, GLboolean, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLsizei, GLsizei, GLubyte*, GLsizei, GL_LUA_ENUMS, const void *)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLhandleARB, GLsizei, GLsizei*, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLint*, GL_LUA_ENUMS)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLint*, GLsizei, GLint*, GL_LUA_ENUMS)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLint*, GL_LUA_ENUMS)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLenum*, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLint, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLdouble, GLdouble, GLint, GLint, GLdouble, GLdouble, GLint, GLint, GLdouble, GLdouble, GLint, GLint, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLchar*const*, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GL_LUA_ENUMS, const void *, GLuint, GL_LUA_ENUMS, GLuint, GL_LUA_ENUMS, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLfloat, GLfloat, GLint, GLint, GLfloat, GLfloat, GLint, GLint, GLfloat, GLfloat, GLint, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLubyte*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLuint, GLsizei, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLhandleARB, GLsizei, GLchar**, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLint, GLsizei, GLint64EXT*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLsizei, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLuint, GLsizei, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLuint, GLsizei, GLuint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLuint*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GLsizei, GLfixed, GLfixed, GLfixed, GLfixed, GLubyte*)', func)
		if ok then
		gl.BitmapxOES = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLsizei, GLenum*, GLint, GLint, GLsizei, GLsizei)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLuint*, GLintptr*, GLsizeiptr*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLuint, GLsizei, GLenum*, GLsizei, GLsizei*, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLubyte(*)(GL_LUA_ENUMS, GLuint)', func)
		if ok then
		gl.GetStringi = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLfloat, GLint)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLuint, GLsizei, GLenum*, GLsizei, GLsizei*, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLsizei, GLuint*, GLintptr*, GLsizei*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GL_LUA_ENUMS, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GL_LUA_ENUMS, GLsizei, GLuint*, GLboolean)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLuint, GLint*, GLsizei*, GLsizei)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLfloat, GLfloat, GLint, GLint, GLfloat, GLfloat, GLint, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLbyte*)', func)
		if ok then
		gl.WeightbvARB = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'GLuint (*)(GL_LUA_ENUMS, GLsizei, GLchar**)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLint, GL_LUA_ENUMS, GLint, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLfloat, GLfloat, GLint, GLint, GLfloat, GLfloat, GLint, GLint, GLfloat*)', func)
		if ok then
		gl.Map2f = func
		end
	end
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLboolean**, GLint)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLsizei, GL_LUA_ENUMS, const void *, GLuint, GL_LUA_ENUMS, GLuint, GL_LUA_ENUMS, GL_LUA_ENUMS, GLfloat*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLint, GLchar*, GLsizei, GLint*, GLchar*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLuint, GLsizei, GLint*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GLuint, GLuint, GLdouble, GLdouble, GLint, GLint, GLdouble*)', func)
		if ok then
...
do
	...
	if func ~= nil then
		local ok, func = pcall(ffi.cast, 'void (*)(GL_LUA_ENUMS, GLdouble, GLdouble, GLint, GLint, GLdouble, GLdouble, GLint, GLint, GLdouble*)', func)
		if ok then
		gl.Map2d = func
		end
	end
