...
for _, info in ipairs(camera.GetVariables()) do
	...
	if info.name == "normal_matrix" then type = "mat3" end
...
render.SetGlobalShaderVariable2("cam_nearz", function()
	return render3d.camera.NearZ
end, "float")

render.SetGlobalShaderVariable2("cam_farz", function()
	return render3d.camera.FarZ
end, "float")

render.SetGlobalShaderVariable2("cam_fov", function()
	return render3d.camera.FOV
end, "float")

render.SetGlobalShaderVariable2("cam_pos", function()
	return render3d.camera:GetPosition()
end, "vec3")

render.SetGlobalShaderVariable2("cam_up", function()
	return render3d.camera:GetAngles():GetUp()
end, "vec3")
