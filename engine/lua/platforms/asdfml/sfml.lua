sfml = {}
sfml.library_path = "lua/platforms/asdfml/bin32/"
sfml.libraries = {}

function sfml.LoadLibraries()
	for file_name in pairs(file.Find(sfml.library_path .. "*")) do
...
do -- header parse
	...
	sfml.headers_path = "lua/platforms/asdfml/headers/"
	
	local function read_header(path)
		return file.Read(sfml.headers_path .. path)
	end
	...
	function sfml.DefineHeaders()
		for file_name in pairs(file.Find(sfml.headers_path .. "*")) do
