...
typedef enum VkExternalSemaphoreHandleTypeFlagBitsKHX{VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX=1,VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX=2,VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX=4,VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX=8,VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX=16,VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX=2147483647};
...
typedef enum VkExternalSemaphoreFeatureFlagBitsKHX{VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX=1,VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX=2,VK_EXTERNAL_SEMAPHORE_FEATURE_FLAG_BITS_MAX_ENUM_KHX=2147483647};
...
typedef enum VkExternalMemoryHandleTypeFlagBitsKHX{VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX=1,VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX=2,VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX=4,VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX=8,VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX=16,VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX=32,VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX=64,VK_EXTERNAL_MEMORY_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX=2147483647};
typedef enum VkColorSpaceKHR{VK_COLOR_SPACE_SRGB_NONLINEAR_KHR=0,VK_COLOR_SPACE_DISPLAY_P3_NONLINEAR_EXT=1000104001,VK_COLOR_SPACE_EXTENDED_SRGB_LINEAR_EXT=1000104002,VK_COLOR_SPACE_DCI_P3_LINEAR_EXT=1000104003,VK_COLOR_SPACE_DCI_P3_NONLINEAR_EXT=1000104004,VK_COLOR_SPACE_BT709_LINEAR_EXT=1000104005,VK_COLOR_SPACE_BT709_NONLINEAR_EXT=1000104006,VK_COLOR_SPACE_BT2020_LINEAR_EXT=1000104007,VK_COLOR_SPACE_HDR10_ST2084_EXT=1000104008,VK_COLOR_SPACE_DOLBYVISION_EXT=1000104009,VK_COLOR_SPACE_HDR10_HLG_EXT=1000104010,VK_COLOR_SPACE_ADOBERGB_LINEAR_EXT=1000104011,VK_COLOR_SPACE_ADOBERGB_NONLINEAR_EXT=1000104012,VK_COLOR_SPACE_PASS_THROUGH_EXT=1000104013,VK_COLOR_SPACE_BEGIN_RANGE_KHR=0,VK_COLOR_SPACE_END_RANGE_KHR=0,VK_COLOR_SPACE_RANGE_SIZE_KHR=1,VK_COLOR_SPACE_MAX_ENUM_KHR=2147483647};
...
typedef enum VkExternalMemoryFeatureFlagBitsKHX{VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX=1,VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX=2,VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX=4,VK_EXTERNAL_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM_KHX=2147483647};
...
struct VkExternalMemoryPropertiesKHX {unsigned int externalMemoryFeatures;unsigned int exportFromImportedHandleTypes;unsigned int compatibleHandleTypes;};
struct VkPhysicalDeviceExternalBufferInfoKHX {enum VkStructureType sType;const void*pNext;unsigned int flags;unsigned int usage;enum VkExternalMemoryHandleTypeFlagBitsKHX handleType;};
struct VkExternalBufferPropertiesKHX {enum VkStructureType sType;void*pNext;struct VkExternalMemoryPropertiesKHX externalMemoryProperties;};
struct VkMemoryFdPropertiesKHX {enum VkStructureType sType;void*pNext;unsigned int memoryTypeBits;};
struct VkPhysicalDeviceExternalSemaphoreInfoKHX {enum VkStructureType sType;const void*pNext;enum VkExternalSemaphoreHandleTypeFlagBitsKHX handleType;};
struct VkExternalSemaphorePropertiesKHX {enum VkStructureType sType;void*pNext;unsigned int exportFromImportedHandleTypes;unsigned int compatibleHandleTypes;unsigned int externalSemaphoreFeatures;};
struct VkImportSemaphoreFdInfoKHX {enum VkStructureType sType;const void*pNext;struct VkSemaphore_T*semaphore;enum VkExternalSemaphoreHandleTypeFlagBitsKHX handleType;int fd;};
...
enum VkResult(vkGetMemoryFdKHX)(struct VkDevice_T*,struct VkDeviceMemory_T*,enum VkExternalMemoryHandleTypeFlagBitsKHX,int*);
...
enum VkResult(vkGetSemaphoreFdKHX)(struct VkDevice_T*,struct VkSemaphore_T*,enum VkExternalSemaphoreHandleTypeFlagBitsKHX,int*);
enum VkResult(vkImportSemaphoreFdKHX)(struct VkDevice_T*,const struct VkImportSemaphoreFdInfoKHX*);
...
void(vkGetPhysicalDeviceExternalSemaphorePropertiesKHX)(struct VkPhysicalDevice_T*,const struct VkPhysicalDeviceExternalSemaphoreInfoKHX*,struct VkExternalSemaphorePropertiesKHX*);
...
void(vkGetPhysicalDeviceExternalBufferPropertiesKHX)(struct VkPhysicalDevice_T*,const struct VkPhysicalDeviceExternalBufferInfoKHX*,struct VkExternalBufferPropertiesKHX*);
...
enum VkResult(vkGetMemoryFdPropertiesKHX)(struct VkDevice_T*,enum VkExternalMemoryHandleTypeFlagBitsKHX,int,struct VkMemoryFdPropertiesKHX*);
...
extensions.vkGetMemoryFdKHX = {ctype = ffi.typeof("enum VkResult(* )( struct VkDevice_T * , struct VkDeviceMemory_T * , enum VkExternalMemoryHandleTypeFlagBitsKHX , int * )")}
...
extensions.vkGetSemaphoreFdKHX = {ctype = ffi.typeof("enum VkResult(* )( struct VkDevice_T * , struct VkSemaphore_T * , enum VkExternalSemaphoreHandleTypeFlagBitsKHX , int * )")}
extensions.vkImportSemaphoreFdKHX = {ctype = ffi.typeof("enum VkResult(* )( struct VkDevice_T * , const struct VkImportSemaphoreFdInfoKHX * )")}
extensions.vkTrimCommandPoolKHR = {ctype = ffi.typeof("void(* )( struct VkDevice_T * , struct VkCommandPool_T * , unsigned int )")}
extensions.vkGetPhysicalDeviceExternalSemaphorePropertiesKHX = {ctype = ffi.typeof("void(* )( struct VkPhysicalDevice_T * , const struct VkPhysicalDeviceExternalSemaphoreInfoKHX * , struct VkExternalSemaphorePropertiesKHX * )")}
...
extensions.vkGetPhysicalDeviceExternalBufferPropertiesKHX = {ctype = ffi.typeof("void(* )( struct VkPhysicalDevice_T * , const struct VkPhysicalDeviceExternalBufferInfoKHX * , struct VkExternalBufferPropertiesKHX * )")}
...
extensions.vkGetMemoryFdPropertiesKHX = {ctype = ffi.typeof("enum VkResult(* )( struct VkDevice_T * , enum VkExternalMemoryHandleTypeFlagBitsKHX , int , struct VkMemoryFdPropertiesKHX * )")}
...
library.e = {
	...
	ERROR_INVALID_EXTERNAL_HANDLE_KHX = ffi.cast("enum VkResult", "VK_ERROR_INVALID_EXTERNAL_HANDLE_KHX"),
	...
	EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX"),
	EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX"),
	EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX"),
	EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX"),
	EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX"),
	EXTERNAL_SEMAPHORE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX"),
	...
	STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX"),
	STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX"),
	STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX"),
	STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX"),
	STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX"),
	STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX"),
	STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX"),
	STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX"),
	STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHX"),
	STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHX"),
	STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHX"),
	STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX"),
	STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX"),
	STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX"),
	STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX"),
	STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX"),
	STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX"),
	STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX"),
	STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX"),
	STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX"),
	STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX"),
	...
	EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX = ffi.cast("enum VkExternalSemaphoreFeatureFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX"),
	EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX = ffi.cast("enum VkExternalSemaphoreFeatureFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX"),
	EXTERNAL_SEMAPHORE_FEATURE_FLAG_BITS_MAX_ENUM_KHX = ffi.cast("enum VkExternalSemaphoreFeatureFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_FEATURE_FLAG_BITS_MAX_ENUM_KHX"),
	...
	EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX"),
	EXTERNAL_MEMORY_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX"),
	...
	EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX"),
	EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX"),
	EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX"),
	EXTERNAL_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM_KHX = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM_KHX"),
	...
	external_memory_feature = {
		exportable = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX"),
		dedicated_only = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX"),
		...
		flag_bits_max_enum = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM_KHX"),
		importable = ffi.cast("enum VkExternalMemoryFeatureFlagBitsKHX", "VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX"),
	},
	object_entry_type = {
	...
	structure_type = {
		...
		export_semaphore_win32_handle_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX"),
		...
		physical_device_external_semaphore_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX"),
		...
		import_memory_fd_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX"),
		...
		memory_fd_properties = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX"),
		...
		external_semaphore_properties = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX"),
		pipeline_viewport_state_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO"),
		import_semaphore_win32_handle_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHX"),
		...
		physical_device_external_image_format_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX"),
		display_surface_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_DISPLAY_SURFACE_CREATE_INFO_KHR"),
		export_semaphore_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX"),
		...
		d3d12_fence_submit_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX"),
		...
		external_image_format_properties = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX"),
		import_semaphore_fd_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX"),
		...
		external_memory_buffer_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX"),
		...
		external_memory_image_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX"),
		...
		physical_device_external_buffer_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX"),
		...
		import_memory_win32_handle_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHX"),
		...
		external_buffer_properties = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX"),
		...
		win32_keyed_mutex_acquire_release_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX"),
		...
		export_memory_allocate_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX"),
		...
		export_memory_win32_handle_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHX"),
		physical_device_id_properties = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX"),
		...
		memory_win32_handle_properties = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHX"),
	...
	external_semaphore_handle_type = {
		flag_bits_max_enum = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM_KHX"),
		opaque_win32_kmt = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX"),
		opaque_fd = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX"),
		opaque_win32 = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX"),
		...
		fence_fd = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX"),
		d3d12_fence = ffi.cast("enum VkExternalSemaphoreHandleTypeFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX"),
	},
	present_mode = {
	...
	external_semaphore_feature = {
		exportable = ffi.cast("enum VkExternalSemaphoreFeatureFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX"),
		...
		flag_bits_max_enum = ffi.cast("enum VkExternalSemaphoreFeatureFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_FEATURE_FLAG_BITS_MAX_ENUM_KHX"),
		importable = ffi.cast("enum VkExternalSemaphoreFeatureFlagBitsKHX", "VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX"),
	},
	command_pool_reset = {
	...
	external_memory_handle_type = {
		d3d11_texture_kmt = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX"),
		...
		opaque_fd = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX"),
		d3d11_texture = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX"),
		...
		d3d12_resource = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX"),
		d3d12_heap = ffi.cast("enum VkExternalMemoryHandleTypeFlagBitsKHX", "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX"),
	},
	shader_stage = {
	...
	result = {
		...
		error_incompatible_driver = ffi.cast("enum VkResult", "VK_ERROR_INCOMPATIBLE_DRIVER"),
		result_begin_range = ffi.cast("enum VkResult", "VK_RESULT_BEGIN_RANGE"),
		error_invalid_external_handle = ffi.cast("enum VkResult", "VK_ERROR_INVALID_EXTERNAL_HANDLE_KHX"),
		not_ready = ffi.cast("enum VkResult", "VK_NOT_READY"),
		error_device_lost = ffi.cast("enum VkResult", "VK_ERROR_DEVICE_LOST"),
...
function library.GetMemoryFd(device, memory, handleType)
	...
	local status = library.GetMemoryFdKHX(device, memory, handleType, box)
...
function library.GetSemaphoreFd(device, semaphore, handleType)
	if type(handleType) == "table" then
		handleType = library.e.external_semaphore_handle_type.make_enums(handleType)
	elseif type(handleType) == "string" then
		handleType = library.e.external_semaphore_handle_type[handleType]
	end
	local box = ffi.new("int [1]")
	local status = library.GetSemaphoreFdKHX(device, semaphore, handleType, box)
...
function library.GetPhysicalDeviceExternalSemaphoreProperties(physicalDevice, pExternalSemaphoreInfo)
	if type(pExternalSemaphoreInfo) == "table" then
		pExternalSemaphoreInfo = library.s.PhysicalDeviceExternalSemaphoreInfoKHX(pExternalSemaphoreInfo, false)
	end
	local box = ffi.new("struct VkExternalSemaphorePropertiesKHX [1]")
	library.GetPhysicalDeviceExternalSemaphorePropertiesKHX(physicalDevice, pExternalSemaphoreInfo, box)
	return box[0]
end
...
function library.GetPhysicalDeviceExternalBufferProperties(physicalDevice, pExternalBufferInfo)
	if type(pExternalBufferInfo) == "table" then
		pExternalBufferInfo = library.s.PhysicalDeviceExternalBufferInfoKHX(pExternalBufferInfo, false)
	end
	local box = ffi.new("struct VkExternalBufferPropertiesKHX [1]")
	library.GetPhysicalDeviceExternalBufferPropertiesKHX(physicalDevice, pExternalBufferInfo, box)
	return box[0]
end
...
function library.GetMemoryFdProperties(device, handleType, fd)
	...
	local box = ffi.new("struct VkMemoryFdPropertiesKHX [1]")
	local status = library.GetMemoryFdPropertiesKHX(device, handleType, fd, box)
...
function library.s.PhysicalDeviceExternalImageFormatInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHX"
	...
	return table_only and tbl or ffi.new("struct VkPhysicalDeviceExternalImageFormatInfoKHX", tbl)
end
function library.s.ExternalImageFormatPropertiesKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHX"
	if type(tbl.externalMemoryProperties) == "table" then
		tbl.externalMemoryProperties = library.s.ExternalMemoryPropertiesKHX(tbl.externalMemoryProperties, true)
	end
	return table_only and tbl or ffi.new("struct VkExternalImageFormatPropertiesKHX", tbl)
end
function library.s.PhysicalDeviceExternalBufferInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHX"
	if type(tbl.flags) == "table" then
		tbl.flags = library.e.buffer_create.make_enums(tbl.flags)
	elseif type(tbl.flags) == "string" then
		tbl.flags = library.e.buffer_create[tbl.flags]
	...
	return table_only and tbl or ffi.new("struct VkPhysicalDeviceExternalBufferInfoKHX", tbl)
end
function library.s.ExternalBufferPropertiesKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHX"
	if type(tbl.externalMemoryProperties) == "table" then
		tbl.externalMemoryProperties = library.s.ExternalMemoryPropertiesKHX(tbl.externalMemoryProperties, true)
	end
	return table_only and tbl or ffi.new("struct VkExternalBufferPropertiesKHX", tbl)
end
function library.s.ExternalMemoryBufferCreateInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHX"
	if type(tbl.handleTypes) == "table" then
		tbl.handleTypes = library.e.external_memory_handle_type.make_enums(tbl.handleTypes)
	elseif type(tbl.handleTypes) == "string" then
		tbl.handleTypes = library.e.external_memory_handle_type[tbl.handleTypes]
	end
	return table_only and tbl or ffi.new("struct VkExternalMemoryBufferCreateInfoKHX", tbl)
end
function library.s.ExternalMemoryImageCreateInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHX"
	if type(tbl.handleTypes) == "table" then
		tbl.handleTypes = library.e.external_memory_handle_type.make_enums(tbl.handleTypes)
	elseif type(tbl.handleTypes) == "string" then
		tbl.handleTypes = library.e.external_memory_handle_type[tbl.handleTypes]
	end
	return table_only and tbl or ffi.new("struct VkExternalMemoryImageCreateInfoKHX", tbl)
end
function library.s.ExportMemoryAllocateInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHX"
	if type(tbl.handleTypes) == "table" then
		tbl.handleTypes = library.e.external_memory_handle_type.make_enums(tbl.handleTypes)
	elseif type(tbl.handleTypes) == "string" then
		tbl.handleTypes = library.e.external_memory_handle_type[tbl.handleTypes]
	end
	return table_only and tbl or ffi.new("struct VkExportMemoryAllocateInfoKHX", tbl)
end
function library.s.ImportMemoryFdInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHX"
	if type(tbl.handleType) == "table" then
		tbl.handleType = library.e.external_memory_handle_type.make_enums(tbl.handleType)
	elseif type(tbl.handleType) == "string" then
		tbl.handleType = library.e.external_memory_handle_type[tbl.handleType]
	end
	return table_only and tbl or ffi.new("struct VkImportMemoryFdInfoKHX", tbl)
end
function library.s.MemoryFdPropertiesKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHX"
	return table_only and tbl or ffi.new("struct VkMemoryFdPropertiesKHX", tbl)
end
function library.s.PhysicalDeviceExternalSemaphoreInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHX"
	if type(tbl.handleType) == "table" then
	...
	return table_only and tbl or ffi.new("struct VkPhysicalDeviceExternalSemaphoreInfoKHX", tbl)
end
function library.s.ExternalSemaphorePropertiesKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHX"
	...
	return table_only and tbl or ffi.new("struct VkExternalSemaphorePropertiesKHX", tbl)
end
function library.s.ExportSemaphoreCreateInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHX"
	if type(tbl.handleTypes) == "table" then
	...
	return table_only and tbl or ffi.new("struct VkExportSemaphoreCreateInfoKHX", tbl)
end
function library.s.ImportSemaphoreFdInfoKHX(tbl, table_only)
	tbl.sType = "VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHX"
	if type(tbl.handleType) == "table" then
		tbl.handleType = library.e.external_semaphore_handle_type.make_enums(tbl.handleType)
	elseif type(tbl.handleType) == "string" then
		tbl.handleType = library.e.external_semaphore_handle_type[tbl.handleType]
	end
	return table_only and tbl or ffi.new("struct VkImportSemaphoreFdInfoKHX", tbl)
end
...
function library.s.PhysicalDeviceExternalImageFormatInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.PhysicalDeviceExternalImageFormatInfoKHX(v)
	end
	return ffi.new("struct VkPhysicalDeviceExternalImageFormatInfoKHX[?]", #tbl, tbl)
end
...
function library.s.ExternalMemoryBufferCreateInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExternalMemoryBufferCreateInfoKHX(v)
	end
	return ffi.new("struct VkExternalMemoryBufferCreateInfoKHX[?]", #tbl, tbl)
end
function library.s.ExternalBufferPropertiesKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExternalBufferPropertiesKHX(v)
	end
	return ffi.new("struct VkExternalBufferPropertiesKHX[?]", #tbl, tbl)
end
...
function library.s.ExternalMemoryImageCreateInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExternalMemoryImageCreateInfoKHX(v)
	end
	return ffi.new("struct VkExternalMemoryImageCreateInfoKHX[?]", #tbl, tbl)
end
...
function library.s.MemoryFdPropertiesKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.MemoryFdPropertiesKHX(v)
	end
	return ffi.new("struct VkMemoryFdPropertiesKHX[?]", #tbl, tbl)
end
...
function library.s.ExternalImageFormatPropertiesKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExternalImageFormatPropertiesKHX(v)
	end
	return ffi.new("struct VkExternalImageFormatPropertiesKHX[?]", #tbl, tbl)
end
...
function library.s.ExternalMemoryPropertiesKHX(tbl, table_only)
	...
	return table_only and tbl or ffi.new("struct VkExternalMemoryPropertiesKHX", tbl)
end
function library.s.ExternalMemoryPropertiesKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExternalMemoryPropertiesKHX(v)
	end
	return ffi.new("struct VkExternalMemoryPropertiesKHX[?]", #tbl, tbl)
end
...
function library.s.ExportMemoryAllocateInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExportMemoryAllocateInfoKHX(v)
	end
	return ffi.new("struct VkExportMemoryAllocateInfoKHX[?]", #tbl, tbl)
end
...
function library.s.PhysicalDeviceExternalBufferInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.PhysicalDeviceExternalBufferInfoKHX(v)
	end
	return ffi.new("struct VkPhysicalDeviceExternalBufferInfoKHX[?]", #tbl, tbl)
end
...
function library.s.ImportSemaphoreFdInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ImportSemaphoreFdInfoKHX(v)
	end
	return ffi.new("struct VkImportSemaphoreFdInfoKHX[?]", #tbl, tbl)
end
function library.s.ExportSemaphoreCreateInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExportSemaphoreCreateInfoKHX(v)
	end
	return ffi.new("struct VkExportSemaphoreCreateInfoKHX[?]", #tbl, tbl)
end
...
function library.s.ExternalSemaphorePropertiesKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ExternalSemaphorePropertiesKHX(v)
	end
	return ffi.new("struct VkExternalSemaphorePropertiesKHX[?]", #tbl, tbl)
end
function library.s.PhysicalDeviceExternalSemaphoreInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.PhysicalDeviceExternalSemaphoreInfoKHX(v)
	end
	return ffi.new("struct VkPhysicalDeviceExternalSemaphoreInfoKHX[?]", #tbl, tbl)
end
...
function library.s.ImportMemoryFdInfoKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.ImportMemoryFdInfoKHX(v)
	end
	return ffi.new("struct VkImportMemoryFdInfoKHX[?]", #tbl, tbl)
end
function library.s.PhysicalDeviceIDPropertiesKHX(tbl, table_only)
	return table_only and tbl or ffi.new("struct VkPhysicalDeviceIDPropertiesKHX", tbl)
end
function library.s.PhysicalDeviceIDPropertiesKHXArray(tbl)
	for i, v in ipairs(tbl) do
		tbl[i] = library.s.PhysicalDeviceIDPropertiesKHX(v)
	end
	return ffi.new("struct VkPhysicalDeviceIDPropertiesKHX[?]", #tbl, tbl)
end
...
function library.ImportSemaphoreFd(device, pImportSemaphoreFdInfo)
	if type(pImportSemaphoreFdInfo) == "table" then
		pImportSemaphoreFdInfo = library.s.ImportSemaphoreFdInfoKHX(pImportSemaphoreFdInfo, false)
	end
	return library.ImportSemaphoreFdKHX(device, pImportSemaphoreFdInfo)
end
