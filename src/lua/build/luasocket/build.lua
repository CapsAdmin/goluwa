...
execute("cp repo/luasec/src/ssl.so \"" .. bin_dir .. "/ssl.so\"")
...
execute("cp repo/luasocket/src/socket*.so \"" .. bin_dir .. "/socket/core.so\"")
execute("cp repo/luasocket/src/mime*.so \"" .. bin_dir .. "/mime/core.so\"")