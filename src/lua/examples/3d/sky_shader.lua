...
vec3 gbuffer_compute_sky(vec3 cam_dir, float depth)
{
	vec3 sunDirection = lua[(vec3)render.GetShaderSunDirection].xyz;
	...
	// in scattering
	float cosTheta = dot(cam_dir, sunDirection);
