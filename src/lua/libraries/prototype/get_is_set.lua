...
function prototype.SetupProperty(info)
	...
	if type(default) == "number" then
		...
		meta[get_name] = meta[get_name] or function(self) return tonumber(self[name]) or default end
	elseif type(default) == "string" then
		...
		meta[get_name] = meta[get_name] or function(self) if self[name] ~= nil then return tostring(self[name]) end return default end
	else
		if callback then
