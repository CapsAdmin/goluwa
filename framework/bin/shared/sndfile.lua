...
SF_BITRATE_MODE_CONSTANT=0,SF_BITRATE_MODE_AVERAGE=1,SF_BITRATE_MODE_VARIABLE=2,
...
SF_SEEK_SET=0,SF_SEEK_CUR=1,SF_SEEK_END=2,};struct sf_private_tag {};
...
struct SF_BROADCAST_INFO { char description[ 256 ] ; char originator[ 32 ] ; char originator_reference[ 32 ] ; char origination_date[ 10 ] ; char origination_time[ 8 ] ; unsigned int time_reference_low ; unsigned int time_reference_high ; short version ; char umid[ 64 ] ; signed short loudness_value ; signed short loudness_range ; signed short max_true_peak_level ; signed short max_momentary_loudness ; signed short max_shortterm_loudness ; char reserved[ 180 ] ; unsigned int coding_history_size ; char coding_history[ 256 ] ;  };
...
library.e = {
	...
	FORMAT_GSM610 = 32,
	FORMAT_VOX_ADPCM = 33,
	FORMAT_NMS_ADPCM_16 = 34,
	FORMAT_NMS_ADPCM_24 = 35,
	FORMAT_NMS_ADPCM_32 = 36,
	FORMAT_G721_32 = 48,
	FORMAT_G723_24 = 49,
	FORMAT_G723_40 = 50,
	FORMAT_DWVW_12 = 64,
	...
	FORMAT_ALAC_24 = 114,
	FORMAT_ALAC_32 = 115,
	FORMAT_MPEG_LAYER_I = 128,
	FORMAT_MPEG_LAYER_II = 129,
	FORMAT_MPEG_LAYER_III = 130,
	ENDIAN_FILE = 0,
	...
	SET_OGG_PAGE_LATENCY_MS = 4866,
	SET_OGG_PAGE_LATENCY = 4867,
	GET_BITRATE_MODE = 4868,
	SET_BITRATE_MODE = 4869,
	SET_CART_INFO = 5120,
	GET_CART_INFO = 5121,
	SET_ORIGINAL_SAMPLERATE = 5376,
	GET_ORIGINAL_SAMPLERATE = 5377,
	...
	CHANNEL_MAP_MAX = 27,
	BITRATE_MODE_CONSTANT = 0,
	BITRATE_MODE_AVERAGE = 1,
	BITRATE_MODE_VARIABLE = 2,
	DEFAULT_LEVEL = 0,
