local ffi = require("ffi");local CLIB = assert(ffi.load("assimp"));ffi.cdef([[typedef enum aiMorphingMethod{aiMorphingMethod_VERTEX_BLEND=1,aiMorphingMethod_MORPH_NORMALIZED=2,aiMorphingMethod_MORPH_RELATIVE=3};
