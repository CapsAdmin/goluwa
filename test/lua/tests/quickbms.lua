local archive_path = steam.GetGamePath("crysis 2") .. "Engine/Engine.pak"
...
local files = utility.QuickBMSGetFiles(archive_path, script)
local file = utility.QuickBMSOpenFile(archive_path, files[1].path, script)
