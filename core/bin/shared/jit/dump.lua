...
local function formatk(tr, idx, sn)
	...
	if slot then s = format("%s @%d", s, slot) end
...
local function dumpon(opt, outfile)
	...
	if m.t or m.b or m.i or m.s or m.m then jit.attach(dump_trace, "trace") end
	...
	if m.x or m.X then jit.attach(dump_texit, "texit") end
