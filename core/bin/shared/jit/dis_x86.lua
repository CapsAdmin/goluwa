...
local map_opc3 = {
	["38"] = { -- [66] 0f 38 xx
		...
		"||psllvVSXrvm",
		--5x
		[0x58] = "||pbroadcastdXrlXm",
		[0x59] = "||pbroadcastqXrlXm",
		[0x5a] = "||broadcasti128XrlXm",
		--7x
		[0x78] = "||pbroadcastbXrlXm",
		[0x79] = "||pbroadcastwXrlXm",
		--8x
		[0x8c] = "||pmaskmovXrvVSm",
		[0x8e] = "||pmaskmovVSmXvr",
		--9x
		[0x96] = "||fmaddsub132pHXrvm",
		[0x97] = "||fmsubadd132pHXrvm",
		[0x98] = "||fmadd132pHXrvm",
		[0x99] = "||fmadd132sHXrvm",
		[0x9a] = "||fmsub132pHXrvm",
		[0x9b] = "||fmsub132sHXrvm",
		[0x9c] = "||fnmadd132pHXrvm",
		[0x9d] = "||fnmadd132sHXrvm",
		[0x9e] = "||fnmsub132pHXrvm",
		[0x9f] = "||fnmsub132sHXrvm",
		--Ax
		[0xa6] = "||fmaddsub213pHXrvm",
		[0xa7] = "||fmsubadd213pHXrvm",
		[0xa8] = "||fmadd213pHXrvm",
		[0xa9] = "||fmadd213sHXrvm",
		[0xaa] = "||fmsub213pHXrvm",
		[0xab] = "||fmsub213sHXrvm",
		[0xac] = "||fnmadd213pHXrvm",
		[0xad] = "||fnmadd213sHXrvm",
		[0xae] = "||fnmsub213pHXrvm",
		[0xaf] = "||fnmsub213sHXrvm",
		--Bx
		[0xb6] = "||fmaddsub231pHXrvm",
		[0xb7] = "||fmsubadd231pHXrvm",
		[0xb8] = "||fmadd231pHXrvm",
		[0xb9] = "||fmadd231sHXrvm",
		[0xba] = "||fmsub231pHXrvm",
		[0xbb] = "||fmsub231sHXrvm",
		[0xbc] = "||fnmadd231pHXrvm",
		[0xbd] = "||fnmadd231sHXrvm",
		[0xbe] = "||fnmsub231pHXrvm",
		[0xbf] = "||fnmsub231sHXrvm",
		--Dx
		[0xdc] = "||aesencXrvm",
		[0xdd] = "||aesenclastXrvm",
		[0xde] = "||aesdecXrvm",
	...
	["3a"] = { -- [66] 0f 3a xx
		...
		nil,
		--3x
		[0x38] = "||inserti128Xrvmu",
		[0x39] = "||extracti128XlXmYru",
		--4x
		[0x40] = "||dppsXrvmu",
		[0x41] = "||dppdXrvmu",
		[0x42] = "||mpsadbwXrvmu",
	...
	for p in gmatch(pat, ".") do
		...
		elseif p == "o" then -- [offset]
			if ctx.x64 then
				...
				if not imm1 then return end

				local imm2 = getimm(ctx, pos + 4, 4)

				if not imm2 then return end
		...
		elseif p == "1" then
			...
			if p == "m" then
				...
				if mode < 3 and (not match(pat, "[aRrgp]") or match(pat, "t")) then -- Yuck.
...
local function dispatch(ctx, opat, patgrp)
	...
	if match(opat, "%$") then -- reg$mem variants.
		...
		if not mrm then return incomplete(ctx) end
