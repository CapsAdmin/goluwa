...
local map_loadc = {
	...
	_ = {shift = 0, mask = 0 -- NYI ldc, mcrr, mrrc.
	},
}
local map_vfps = {
	shift = 6,
	...
	[0x2c001] = {
		...
		[0x0a01] = "vcmpzeF.d",
		[0x0e01] = "vcvtG.dF.m",
		[0x1000] = "vcvt.f32.u32Fdm",
		[0x1001] = "vcvt.f32.s32Fdm",
		[0x1800] = "vcvtr.u32F.dm",
		[0x1801] = "vcvt.u32F.dm",
		[0x1a00] = "vcvtr.s32F.dm",
		[0x1a01] = "vcvt.s32F.dm",
	},
}
local map_vfpd = {
	...
	[0x2c001] = {
		...
		[0x0a01] = "vcmpzeG.d",
		[0x0e01] = "vcvtF.dG.m",
		[0x1000] = "vcvt.f64.u32GdFm",
		[0x1001] = "vcvt.f64.s32GdFm",
		[0x1800] = "vcvtr.u32FdG.m",
		[0x1801] = "vcvt.u32FdG.m",
		[0x1a00] = "vcvtr.s32FdG.m",
		[0x1a01] = "vcvt.s32FdG.m",
	},
}
local map_datac = {
	shift = 24,
...
local map_loadcu = {
	shift = 0,
	mask = 0, -- NYI unconditional CP load/store.
}
local map_datacu = {
	shift = 0,
	mask = 0, -- NYI unconditional CP data.
}
local map_simddata = {
	shift = 0,
	mask = 0, -- NYI SIMD data.
}
local map_simdload = {
	shift = 0,
	mask = 0, -- NYI SIMD load/store, preload.
}
local map_preload = {
	shift = 0,
	mask = 0, -- NYI preload.
...
local map_branch = {shift = 24, mask = 1, [0] = "bB", "blB"}
local map_condins = {
	[0] = map_datar,
	map_datai,
	map_load,
