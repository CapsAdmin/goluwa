...
stage.warnings = {
	["531"] = {
		message_format = "right side of assignment has more values than left side expects",
		fields = {},
	},
	["532"] = {
		message_format = "right side of assignment has less values than left side expects",
		fields = {},
	},
}
