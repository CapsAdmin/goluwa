	...
	info = {
		...
		response = {
			...
			}, -- Indicates the type of server
			{
				"char",
				"Environment",
				translate = {l = "Linux", w = "Windows", m = "Mac", o = "Mac"},
			...
			{"byte", "ExtraDataFlag"}, -- If present, this specifies which additional data fields will be included.
			{
				...
				"Port",
				match = {
					ExtraDataFlag = function(num)
						return bit.band(num, 0x80)
					end,
				},
