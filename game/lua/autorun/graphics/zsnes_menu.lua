...
local function MessageBox(title, msg, callback)
	...
	yes.label:SetMargin(Rect(4, 0, 2, 0))
	yes:SetMargin(Rect() + 20)
	...
	no.label:SetMargin(Rect(4, 0, 2, 0))
	no:SetColor(Color(1, 1, 1.5, 1) * 1.4)
	no:SetMargin(Rect() + 20)
...
local function LoadLua(bar)
	...
	bottom:SetPadding(Rect(8, 0, 8, 0))
	...
	do
		local area = bottom3:CreatePanel("base")
		area:SetMargin(Rect() + 2)
		area:SetPadding(Rect(10, 0, 10, 0))
		area:SetHeight(100)
		area:SetWidth(220)
		...
		do
			...
			left:SetMargin(Rect() + 2)
			left:SetPadding(Rect(10, 0, 10, 0))
		...
		do
			...
			right:SetMargin(Rect() + 2)
			right:SetPadding(Rect(10, 0, 10, 0))
...
function menu.CreateTopBar()
	...
	local function create_button(text, options, w)
		...
		button:SetText(text)
		button:SetPadding(Rect(S * 2 - w, S * 1, S * 2 - w, S * 1))
		button:SetMargin(Rect(S * 2, S, S * 2, S))
