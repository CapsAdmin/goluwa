...
do
	local function check_single(id, no_linenumbers, suspicious_only)
		...
		logn(
			"==============================",
			info.publishedfiledetails[1].title,
			"=============================="
		)
		logn(
			"http://steamcommunity.com/workshop/filedetails/?id=" .. info.publishedfiledetails[1].publishedfileid
		)
